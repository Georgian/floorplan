...
public class FontSizeTwentyfiveAction extends SelectionAction {
	...
	public FontSizeTwentyfiveAction(final IWorkbenchPart part, final CanvasModel model) {
		super(part);
		this.model = model;
	...
	public void run() {
		...
		if (selection == 0) {
			for (final ChildModel childModel : model.getChildren())
				childModel.setFontSize( FPFontSize.XXXL.getPercent()/10 );
		}
	}
	...
	public String getValue() {
		return String.valueOf( FPFontSize.XXXL.getPercent()/10 );
	}
