...
public class FontSizeSixteenAction extends SelectionAction {
	...
	public FontSizeSixteenAction(final IWorkbenchPart part, final CanvasModel model) {
		super(part);
		this.model = model;
	...
	public void run() {
		...
		if (selection == 0) {
			for (final ChildModel childModel : model.getChildren())
				childModel.setFontSize( FPFontSize.XL.getPercent()/10 );
		}
	}
	...
	public String getValue() {
		return String.valueOf( FPFontSize.XL.getPercent()/10 );
	}
